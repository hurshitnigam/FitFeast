    ...
    return (
        <div className='relative w-full h-screen bg-[#FAEADE]'>
            <div className="absolute flex flex-col text-7xl font-[Antonio] text-center ml-16 bottom-60">
                <h1>Cookie Fudge</h1>
                <h1 className='bg-[#BE812D] border-4 py-2 px-3 border-amber-700 text-[#FAEADE] -rotate-3 mt-3'>Peanut Butter</h1>
            </div>
            <div className="absolute scale-75 flex items-center justify-center left-80 bottom-3">
                <img src="https://fitfeast.in/cdn/shop/files/COOKIESFUDGE.png?v=1752126621&width=823" alt="" />
            </div>
...
export default CookieFudgePeanutButter
