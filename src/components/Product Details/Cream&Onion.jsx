...
const CreamOnion = () => {
    return (
        <div className='relative w-full h-screen bg-[#FAEADE]'>
            ...
            <div className="absolute scale-65 flex items-center justify-center left-80 bottom-3">
                <img src="https://fitfeast.in/cdn/shop/files/CreamAndOnion1.png?v=1752126036&width=823" alt="" />
            </div>
