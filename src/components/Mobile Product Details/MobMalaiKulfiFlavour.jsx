    ...
    return (
        <div className="w-full min-h-screen bg-[#FAEADE] px-4 py-10 flex flex-col items-center justify-start gap-8">
            ...
            <div className="text-center font-[Antonio]">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Malai Kulfi</h1>
            ...
            <div className="flex justify-center">
                <img
                    ...
                    src="https://fitfeast.in/cdn/shop/files/malaikulfi_1.png?v=1752124889&width=823"
                    alt="White Malai Kulfi Peanut Butter"
                />
            </div>
            ...
            <div className="w-full max-w-2xl text-[#1E2A47] text-center space-y-4 px-2">
                <h2 className="text-2xl font-bold">Why is having a Malai Kulfi sachet pure bliss?</h2>
                <p>
                The Malai Kulfi Brownie Protein Shake isn't just delicious—it's super convenient! With its easy-to-carry sachet, you can enjoy 20g of protein anytime, anywhere. Just mix, sip, and fuel up—perfect for busy mornings, post-gym recovery, or when you're on the go.
                </p>
                <p>
                    <strong>Overall health - contains eucalyptus honey and high quality ingredients</strong>
                </p>
                <ul className="list-disc text-left pl-6 space-y-1">
                    <li>Sugar cravings - same delicious taste as Malai Kulfi spreads</li>
                ...
                <div className="w-full flex flex-col md:flex-row justify-center items-center gap-6 mt-8">
                    <div className="flex gap-5">
                        <div className="text-center bg-[#FDEBD2] text-[#BE812D] border-2 border-[#BE812D] px-4 py-1 rounded-2xl">
                            <p>Pack of 7</p>
                            <p className="mt-1 font-semibold text-lg">₹686</p>
                        </div>
                        <div className="text-center bg-[#FDEBD2] text-[#BE812D] border-2 border-[#BE812D] px-4 py-1 rounded-2xl">
                            <p>Pack of 21</p>
                            <p className="mt-1 font-semibold text-lg">₹1,767</p>
                        </div>
                    </div>
...
export default MobMalaiKulfiFlavour
