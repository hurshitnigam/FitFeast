    ...
    return (
        <div className="w-full min-h-screen bg-[#FAEADE] px-4 py-10 flex flex-col items-center justify-start gap-8">
            ...
            <div className="text-center font-[Antonio]">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Mocha & Nutty</h1>
            ...
            <div className="flex justify-center">
                <img
                    ...
                    src="https://fitfeast.in/cdn/shop/files/Mocha_and_Nutty.png?v=1752125542&width=823"
            ...
            <div className="w-full max-w-2xl text-[#1E2A47] text-center space-y-4 px-2">
                <h2 className="text-2xl font-bold">Two flavors. One perfect box.</h2>
                <p>
                    Why pick one when you can enjoy both?
                </p>
                <p>
                    <strong>Mocha Boost brings the coffee-chocolate combo you crave, while Nutty Brownie hits that fudgy, dessert-like sweet spot.</strong>
                </p>
                ...
                <div className="w-full flex flex-col md:flex-row justify-center items-center gap-6 mt-8">
                    <div className="flex gap-5">
                        <div className="text-center bg-[#FDEBD2] text-[#BE812D] border-2 border-[#BE812D] px-4 py-1 rounded-2xl">
                            <p>Pack of 12</p>
                            <p className="mt-1 font-semibold text-lg">₹1,242</p>
                        </div>
                        <div className="text-center bg-[#FDEBD2] text-[#BE812D] border-2 border-[#BE812D] px-4 py-1 rounded-2xl">
                            <p>Pack of 18</p>
                            <p className="mt-1 font-semibold text-lg">₹1,765</p>
                        </div>
                    </div>
