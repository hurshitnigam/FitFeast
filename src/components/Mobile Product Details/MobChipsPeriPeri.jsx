    ...
    return (
        <div className="w-full min-h-screen bg-[#FAEADE] px-4 py-10 flex flex-col items-center justify-start gap-8">
            ...
            <div className="text-center font-[Antonio]">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Peri Peri</h1>
            ...
            <div className="flex justify-center">
                <img
                    ...
                    src="https://fitfeast.in/cdn/shop/files/PERIPERI1_503413d8-674f-496a-87b0-2ca6ec25a4b5.png?v=1752125734&width=823"
...
export default MobChipsPeriPeri
