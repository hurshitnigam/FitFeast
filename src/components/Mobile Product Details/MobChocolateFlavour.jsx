    ...
    return (
        <div className="w-full min-h-screen bg-[#FAEADE] px-4 py-10 flex flex-col items-center justify-start gap-8">
            ...
            <div className="text-center font-[Antonio]">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Chocolate Flavour</h1>
            ...
            <div className="flex justify-center">
                <img
                    ...
                    src="https://fitfeast.in/cdn/shop/files/ChocolateSHAKE.png?v=1752125138&width=823"
            ...
            <div className="w-full max-w-2xl text-[#1E2A47] text-center space-y-4 px-2">
                <h2 className="text-2xl font-bold">Why is having a chocolate sachet pure bliss?</h2>
                <p>
                The Chocolate Brownie Protein Shake isn't just delicious—it's super convenient! With its easy-to-carry sachet, you can enjoy 20g of protein anytime, anywhere. Just mix, sip, and fuel up—perfect for busy mornings, post-gym recovery, or when you're on the go.
                </p>
                <p>
...
export default MobChocolateFlavour
