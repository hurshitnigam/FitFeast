...
const MobCookieFudgePeanutButter = () => {
    return (
        <div className="w-full min-h-screen bg-[#FAEADE] px-4 py-10 flex flex-col items-center justify-start gap-8">
            ...
            <div className="text-center font-[Antonio]">
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">Cookie Fudge</h1>
            ...
            <div className="flex justify-center">
                <img
                    ...
                    src="https://fitfeast.in/cdn/shop/files/COOKIESFUDGE.png?v=1752126621&width=823"
...
export default MobCookieFudgePeanutButter
