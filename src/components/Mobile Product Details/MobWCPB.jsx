  ...
  return (
    <div className="w-full min-h-screen bg-[#FAEADE] px-4 py-10 flex flex-col items-center justify-start gap-8">
      ...
      <div className="text-center font-[Antonio]">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">White Chocolate</h1>
      ...
      <div className="flex justify-center">
        <img
          ...
          src="https://fitfeast.in/cdn/shop/files/WhiteChocolate_99a0b865-f874-437a-b0ab-d7ff56fd4136.png?v=1752126412&width=823"
        ...
        <div className="w-full flex flex-col md:flex-row justify-center items-center gap-6 mt-8">
          <div className="flex gap-5">
            <div className="text-center bg-[#FDEBD2] text-[#BE812D] border-2 border-[#BE812D] px-4 py-1 rounded-2xl">
              <p>Pack of 1</p>
              <p className="mt-1 font-semibold text-lg">₹323</p>
            </div>
            <div className="text-center bg-[#FDEBD2] text-[#BE812D] border-2 border-[#BE812D] px-4 py-1 rounded-2xl">
              <p>Pack of 2</p>
              <p className="mt-1 font-semibold text-lg">₹610</p>
            </div>
          </div>
